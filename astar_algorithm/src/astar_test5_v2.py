...
class AStarPlannerNode(Node):
    ...
    def __init__(self):
        ...
        # self.yaml_config_path = 'report_map.yaml'
          # Map image and configuration file paths
        self.map_image_path = os.path.join(os.path.dirname(__file__), 'report_map.pgm')  # Assume it's in the same directory as this script
        self.yaml_config_path = 'report_map.yaml'
        ...
        try:
            ...
            self.get_logger().error(f"Error loading map image: {str(e)}")
    ...
    def run_planner(self):
        ...
        # Append path points (replace with your A* path points)
        path_points = []  # Replace with your computed path points
