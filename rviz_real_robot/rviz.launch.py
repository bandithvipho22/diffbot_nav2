...
def generate_launch_description():
    ...
    pkg_share = launch_ros.substitutions.FindPackageShare(package='ros_foxy').find('ros_foxy')
    ...
    # ),
        ...
        Node(
            ...
            arguments=['0.03', '0', '0.17', '0', '0', '0', 'base_link', 'laser_frame'],
            output='screen'
        ),
                 Node(
             package='tf2_ros',
             executable='static_transform_publisher',
             arguments=['-0.05', '0.0', '0.17', '0', '0', '0', 'base_link', 'bno055'],
            output='screen'
         ),
         Node(
            package='tf2_ros',
