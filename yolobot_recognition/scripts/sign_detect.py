...
class Camera_subscriber(Node):
    ...
    def __init__(self):
        ...
        self.model = YOLO('/home/vipho/dev_ws/src/yolobot_recognition/scripts/yolov8n.pt')
        ...
        self.img_pub = self.create_publisher(Image, "/detect_result", 1)
    ...
    def camera_callback(self, data):
        ...
        for r in results:
            ...
            for box in boxes:
                ...
                self.inference_result.x = int(b[0])
                self.inference_result.y = int(b[1])
